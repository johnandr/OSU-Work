...
const char *WINDOWTITLE = { "OpenCL/OpenGL Particle System -- Andrew Johnson" };
...
const int NUM_PARTICLES = 1024*64;
const int LOCAL_SIZE    = 32;
const char *CL_FILE_NAME   = { "johnandr.cl" };
